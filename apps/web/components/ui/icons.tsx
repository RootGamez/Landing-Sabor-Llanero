/**
 * Set de iconos SVG inline (estilo Lucide, trazo 2px consistente).
 * Regla de diseño: nunca emojis como iconos estructurales.
 */
interface IconProps {
  className?: string;
}
...
export function WheatIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M2 22 16 8" />
      ...
      <path d="m16 8 2-2c1.5-1.5 4-1 4-1s.5 2.5-1 4l-2 2" />
    </svg>
  );
}

export function HeartHandsIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
export function BikeIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <circle cx="5.5" cy="17.5" r="3.5" />
      <circle cx="18.5" cy="17.5" r="3.5" />
      <path d="M15 6h2.5l2 4" />
      <path d="M5.5 17.5 9 11h5l3 6.5" />
      <path d="M9 11 7.5 7.5H5" />
    </svg>
  );
}
...
export function PizzaSliceIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M15 11h.01" />
      <path d="M11 15h.01" />
